    ...
    constructor(options) {
        ...
        <section class="color-section">
            <div class="color-fire-btn" id="color-fire-btn">
                ${this.pluginType === 'marker' ? MARKER : `<div class="color-fire-btn-text"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 0C5.37333 0 0 5.59722 0 12.5C0 19.4028 5.37333 25 12 25C13.1067 25 14 24.0694 14 22.9167C14 22.375 13.8 21.8889 13.48 21.5139C13.1733 21.1528 12.9733 20.6667 12.9733 20.1389C12.9733 18.9861 13.8667 18.0556 14.9733 18.0556H17.3333C21.0133 18.0556 24 14.9444 24 11.1111C24 4.97222 18.6267 0 12 0ZM4.66667 12.5C3.56 12.5 2.66667 11.5694 2.66667 10.4167C2.66667 9.26389 3.56 8.33333 4.66667 8.33333C5.77333 8.33333 6.66667 9.26389 6.66667 10.4167C6.66667 11.5694 5.77333 12.5 4.66667 12.5ZM8.66667 6.94444C7.56 6.94444 6.66667 6.01389 6.66667 4.86111C6.66667 3.70833 7.56 2.77778 8.66667 2.77778C9.77333 2.77778 10.6667 3.70833 10.6667 4.86111C10.6667 6.01389 9.77333 6.94444 8.66667 6.94444ZM15.3333 6.94444C14.2267 6.94444 13.3333 6.01389 13.3333 4.86111C13.3333 3.70833 14.2267 2.77778 15.3333 2.77778C16.44 2.77778 17.3333 3.70833 17.3333 4.86111C17.3333 6.01389 16.44 6.94444 15.3333 6.94444ZM19.3333 12.5C18.2267 12.5 17.3333 11.5694 17.3333 10.4167C17.3333 9.26389 18.2267 8.33333 19.3333 8.33333C20.44 8.33333 21.3333 9.26389 21.3333 10.4167C21.3333 11.5694 20.44 12.5 19.3333 12.5Z" fill="black"/>
                </svg>
                </div>` }
            </div>
