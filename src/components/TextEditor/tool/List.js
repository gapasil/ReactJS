  ...
  class List {
    ...
    static get toolbox() {
      return {
        ...
        <path d="M2.10811 8.43243C0.941622 8.43243 0 9.37405 0 10.5405C0 11.707 0.941622 12.6486 2.10811 12.6486C3.27459 12.6486 4.21622 11.707 4.21622 10.5405C4.21622 9.37405 3.27459 8.43243 2.10811 8.43243ZM2.10811 0C0.941622 0 0 0.941622 0 2.10811C0 3.27459 0.941622 4.21622 2.10811 4.21622C3.27459 4.21622 4.21622 3.27459 4.21622 2.10811C4.21622 0.941622 3.27459 0 2.10811 0ZM2.10811 16.8649C0.941622 16.8649 0 17.8205 0 18.973C0 20.1254 0.955676 21.0811 2.10811 21.0811C3.26054 21.0811 4.21622 20.1254 4.21622 18.973C4.21622 17.8205 3.27459 16.8649 2.10811 16.8649ZM6.32432 20.3784H26V17.5676H6.32432V20.3784ZM6.32432 11.9459H26V9.13513H6.32432V11.9459ZM6.32432 0.702703V3.51351H26V0.702703H6.32432Z" fill="black"/>
        </svg>
        `,
        title: 'List',
      };
    ...
    render() {
      ...
      if (this._data.items.length) {
        ...
        div.appendChild(this._elements.wrapper)
      } else {
         ...
         button.classList.add("deleteBlock")
 
         this._elements.wrapper.appendChild(this._make('li', this.CSS.item));
 
         div.classList.add("decList")
         div.appendChild(this._elements.wrapper)
    ...
    /**
     * Creates main <ul> or <ol> tag depended on stylece-paragraphC
     *
